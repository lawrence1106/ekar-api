...
app.get("/", (req, res) => {
  res.send(
    "<h1>Working Routes</h1> <br><h4>Get Units: '/getUnits'</h4><p>Get Request</p><br><h4>Get Unit Interval: '/getUnitInterval'</h4><p>POST Request(For Demo)</p><p>Query Parameters:</p><p>device_id</p><p>start_time</p><p>end_time</p>" +
